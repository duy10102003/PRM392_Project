                                            ...
                                            .addOnCompleteListener(userTask -> {
                                                if (userTask.isSuccessful()) {
                                                    ...
                                                    if (document != null && document.exists()) {
                                                        ...
                                                        if (role != null && (role.equals("admin0") || role.equals("admin1") || role.equals("admin2"))) {
                                                    ...
                                                    Toast.makeText(LoginActivity.this, "Lỗi khi lấy thông tin người dùng: " + userTask.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                }
                            } else {
